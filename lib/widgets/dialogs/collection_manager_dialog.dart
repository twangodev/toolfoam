...
class CollectionManagerDialog extends StatefulWidget {
  ...
  @override
  State<CollectionManagerDialog> createState() =>
      _CollectionManagerDialogState();
}
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return CollectionCard(
                            ...
                            shouldNullifySelectedUponDelete: () =>
                                widget.selectedCollection() == collection,
                            onCollectionSelected: (TfCollection? collection) {
...
class _CollectionCardState extends State<CollectionCard> {
  ...
  Widget build(BuildContext context) {
    ...
    String lastChangedDescriptor =
        (lastUpdate.isAfter(createdAt)) ? 'Last Updated ' : 'Created ';
    ...
    return Card(
        ...
        child: ListTile(
            ...
            title: Text(name ?? 'Placeholder Name',
                style:
                    const TextStyle(fontSize: 18)), // TODO null name condition
            subtitle: Row(children: [
              Text('Tools: $toolCount, Layouts: $layoutCount - ',
                  style: subtitleStyle),
