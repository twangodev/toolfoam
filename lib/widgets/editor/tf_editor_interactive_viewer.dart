...
class TfEditorInteractiveViewer extends StatefulWidget {
  ...
  final Set<int> illegalMousePanSet;
  final bool ignoreIllegalMousePan;
...
class _TfEditorInteractiveViewerState extends State<TfEditorInteractiveViewer> with TickerProviderStateMixin {
  ...
  bool isUsingIllegalMouse = false;
  bool activelyRejectingIllegalMouse = false;
  ...
  void _onScaleStart(ScaleStartDetails details) {
    ...
    if (!widget.ignoreIllegalMousePan && isUsingIllegalMouse) {
      activelyRejectingIllegalMouse = true;
    }
  ...
  void _onScaleUpdate(ScaleUpdateDetails details) {
    ...
    switch (_gestureType!) {
      ...
      case _GestureType.pan:
        ...
        if (activelyRejectingIllegalMouse) {
          return;
        }
  ...
  void _onScaleEnd(ScaleEndDetails details) {
    ...
    if (activelyRejectingIllegalMouse) {
      activelyRejectingIllegalMouse = false;
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Listener(
      ...
      onPointerDown: (PointerDownEvent event) {
        if (widget.illegalMousePanSet.contains(event.buttons)) {
          isUsingIllegalMouse = true;
        }
      },
      onPointerUp: (PointerUpEvent event) {
        isUsingIllegalMouse = false;
      },
